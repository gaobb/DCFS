...
NUNMGPU=$2
EXPNAME=$3
SAVEDIR=workspace/DCFS/coco-det/${EXPNAME}  #<-- change it to your path
...
BASE_WEIGHT=${SAVEDIR}/dcfs_det_${NET}_base/model_reset_remove.pth
...
do
    ...
    do        
        ...
        OUTPUT_DIR=${SAVEDIR}/dcfs_fsod_${NET}_novel/tfa-like-${classloss}/${shot}shot_seed${seed}
...
# python3 tools/extract_results.py --res-dir ${SAVEDIR}/dcfs_fsod_${NET}_novel/tfa-like-${classloss} --shot-list 1 2 3 5 10 30  
...
# surmarize all results
# python3 tools/extract_results.py --res-dir ${SAVEDIR}/dcfs_gfsod_${NET}_novel/tfa-like-${classloss} --shot-list 1 2 3 5 10 30
